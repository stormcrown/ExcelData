...
//            cellStyle_title.setFillForegroundColor(IndexedColors.YELLOW.index);
        ...
        for(int i=1;i<19;i++){
          Cell x=  title.createCell(i); x.setCellStyle(cellStyle_title);
        }
        ...
        Cell cell_2_0 = ttile_row.createCell(0); cell_2_0.setCellValue("业务部");cell_2_0.setCellStyle(style_title2);
        Cell cell_2_1 = ttile_row.createCell(1); cell_2_1.setCellValue("产品类型");cell_2_1.setCellStyle(style_title2);
        Cell cell_2_2 = ttile_row.createCell(2); cell_2_2.setCellValue("客户编码");cell_2_2.setCellStyle(style_title2);
        Cell cell_2_3 = ttile_row.createCell(3); cell_2_3.setCellValue("客户名");cell_2_3.setCellStyle(border_title);
        Cell cell_2_4 = ttile_row.createCell(4); cell_2_4.setCellValue("行业");cell_2_4.setCellStyle(border_title);
        Cell cell_2_5 = ttile_row.createCell(5); cell_2_5.setCellValue("需求部门");cell_2_5.setCellStyle(border_title);
        Cell cell_2_6 = ttile_row.createCell(6); cell_2_6.setCellValue("优化师");cell_2_6.setCellStyle(border_title);
        Cell cell_2_7 = ttile_row.createCell(7); cell_2_7.setCellValue("视频类型");cell_2_7.setCellStyle(border_title);
        Cell cell_2_8 = ttile_row.createCell(8); cell_2_8.setCellValue("成片日期");cell_2_8.setCellStyle(border_title);
        Cell cell_2_9 = ttile_row.createCell(9); cell_2_9.setCellValue("创意");cell_2_9.setCellStyle(style_title2);
        Cell cell_2_10 = ttile_row.createCell(10); cell_2_10.setCellValue("摄像");cell_2_10.setCellStyle(style_title2);
        Cell cell_2_11 = ttile_row.createCell(11); cell_2_11.setCellValue("剪辑");cell_2_11.setCellStyle(style_title2);
        Cell cell_2_12 = ttile_row.createCell(12); cell_2_12.setCellValue("演员1");cell_2_12.setCellStyle(style_title2);
        Cell cell_2_13 = ttile_row.createCell(13); cell_2_13.setCellValue("演员2");cell_2_13.setCellStyle(style_title2);
        Cell cell_2_14 = ttile_row.createCell(14); cell_2_14.setCellValue("演员3");cell_2_14.setCellStyle(style_title2);
        Cell cell_2_15 = ttile_row.createCell(15); cell_2_15.setCellValue("当日消耗");cell_2_15.setCellStyle(style_title2);
        Cell cell_2_16 = ttile_row.createCell(16); cell_2_16.setCellValue("累计消耗");cell_2_16.setCellStyle(style_title2);
        Cell cell_2_17 = ttile_row.createCell(17); cell_2_17.setCellValue("累计排名");cell_2_17.setCellStyle(style_title2);
        Cell cell_2_18 = ttile_row.createCell(18); cell_2_18.setCellValue("数据日期");cell_2_18.setCellStyle(style_title2);
        ...
        if(videoCosts!=null){
          ...
          //  DataFormat money_format= sheet.getWorkbook().createDataFormat();
            ...
            for(int i=0;i<videoCosts.size();i++){
                ...
                Cell cell_i_0 = data_row.createCell(0);cell_i_0.setCellStyle(border);
                Cell cell_i_1 = data_row.createCell(1);cell_i_1.setCellStyle(border);
                Cell cell_i_2 = data_row.createCell(2);cell_i_2.setCellStyle(border);
                Cell cell_i_3 = data_row.createCell(3);cell_i_3.setCellStyle(border);
                Cell cell_i_4 = data_row.createCell(4);cell_i_4.setCellStyle(border);
                Cell cell_i_5 = data_row.createCell(5);cell_i_5.setCellStyle(border);
                Cell cell_i_6 = data_row.createCell(6);cell_i_6.setCellStyle(border);
                Cell cell_i_7 = data_row.createCell(7);cell_i_7.setCellStyle(border);
                Cell cell_i_8 = data_row.createCell(8);cell_i_8.setCellStyle(cellStyle_date);
                Cell cell_i_9 = data_row.createCell(9);cell_i_9.setCellStyle(border);
                Cell cell_i_10 = data_row.createCell(10);cell_i_10.setCellStyle(border);
                Cell cell_i_11 = data_row.createCell(11);cell_i_11.setCellStyle(border);
                Cell cell_i_12 = data_row.createCell(12);cell_i_12.setCellStyle(border);
                Cell cell_i_13 = data_row.createCell(13);cell_i_13.setCellStyle(border);
                Cell cell_i_14 = data_row.createCell(14);cell_i_14.setCellStyle(border);
                Cell cell_i_15 = data_row.createCell(15);cell_i_15.setCellStyle(cellStyle_money);
                Cell cell_i_16 = data_row.createCell(16);cell_i_16.setCellStyle(cellStyle_money);
                Cell cell_i_17 = data_row.createCell(17);;cell_i_17.setCellStyle(border);
                Cell cell_i_18 = data_row.createCell(18);cell_i_18.setCellStyle(cellStyle_date);

                if(videoCost.getBusinessDepartment()!=null) cell_i_0.setCellValue(videoCost.getBusinessDepartment().getName());
                if(videoCost.getProductType()!=null) cell_i_1.setCellValue(videoCost.getProductType().getName());
                ...
                if(videoCost.getIndustry()!=null) cell_i_4.setCellValue(videoCost.getIndustry().getName());
                ...
                if(videoCost.getVideoType()!=null) cell_i_7.setCellValue(videoCost.getVideoType().getName());
                if(videoCost.getCompleteDate()!=null) cell_i_8.setCellValue(videoCost.getCompleteDate());
                if(videoCost.getOriginality()!=null) cell_i_9.setCellValue(videoCost.getOriginality().getName());
                if(videoCost.getPhotographer()!=null) cell_i_10.setCellValue(videoCost.getPhotographer().getName());
                if(videoCost.getEditor()!=null) cell_i_11.setCellValue(videoCost.getEditor().getName());
                if(videoCost.getPerformer1()!=null) cell_i_12.setCellValue(videoCost.getPerformer1().getName());
                if(videoCost.getPerformer2()!=null) cell_i_13.setCellValue(videoCost.getPerformer2().getName());
                if(videoCost.getPerformer3()!=null) cell_i_14.setCellValue(videoCost.getPerformer3().getName());
                if(videoCost.getConsumption()!=null) cell_i_15.setCellValue(videoCost.getConsumption());
                if(videoCost.getCumulativeConsumptionByPro()!=null) cell_i_16.setCellValue(videoCost.getCumulativeConsumptionByPro());
        ...
        for(int i=0;i<5;i++){
            Cell x=  row1.createCell(i); x.setCellStyle(cellStyle_title);
        ...
        row5.createCell(0).setCellValue("数据日期起始：");
        ...
        row6.createCell(0).setCellValue("数据日期结束：");
