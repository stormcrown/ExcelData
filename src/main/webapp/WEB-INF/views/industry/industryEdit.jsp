...
<script type="text/javascript">
    $(function() {
        ...
        $("#editStatus").val('${industry.status}'); 
    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="industryEditForm" method="post">
            <table class="grid">
                <tr>
                    <td>商家名称</td>
                    <td><input name="id" type="hidden"  value="${industry.id}">
                    <input name="name" type="text" placeholder="请输入名称" class="easyui-validatebox" data-options="required:true" value="${industry.name}"></td>
                </tr>
                <tr>
                    <td>状态</td>
                    <td >
