...
function performerAddFun() {
        var id = "";
        var checks = $('#performerDataGrid').datagrid('getChecked');
...
<div id="performerToolbar" style="display: none;">
    ...
    <shiro:hasPermission name="/performer/delete">
        <a onclick="performerDeleteFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'glyphicon-remove  icon-red'">删除</a>
    </shiro:hasPermission>
    <shiro:hasPermission name="/performer/add">
