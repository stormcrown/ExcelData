    ...
    $(function() {
        $('#videoCostimportExcelForm').form({
            ...
            onSubmit : function() {
                ...
                console.log($('#recoredDate').datebox('getValue'));
                return isValid;
            },
    ...
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
        <form id="videoCostimportExcelForm" method="post" enctype="multipart/form-data">
            <table class="grid">
                <tr>
                    <td>Excel文件</td>
                    <td><input name="excels" type="file" accept=".xls,.xlsx" placeholder="请输入累计消耗排名" class="easyui-validatebox span2" data-options="prompt:'请输入累计消耗排名',required:false" value=""></td>
                </tr>
                <tr>
                    <td>数据日期</td>
