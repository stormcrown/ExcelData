...
function optimizerAddFun() {
        var id = "";
        var checks = $('#optimizerDataGrid').datagrid('getChecked');
...
<div id="optimizerToolbar" style="display: none;">
    ...
    <shiro:hasPermission name="/optimizer/delete">
        <a onclick="optimizerDeleteFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'glyphicon-remove  icon-red'">删除</a>
    </shiro:hasPermission>
    <shiro:hasPermission name="/optimizer/add">
